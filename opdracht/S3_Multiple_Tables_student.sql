...
-- SELECT m_cursist.naam AS cursist, m_docent.naam AS docent
-- FROM inschrijvingen i
-- JOIN medewerkers m_cursist ON i.cursist = m_cursist.mnr
-- JOIN uitvoeringen u ON i.cursus = u.cursus AND i.begindatum = u.begindatum
-- JOIN medewerkers m_docent ON u.docent = m_docent.mnr
-- WHERE i.cursus = 'S02';
...
-- FROM afdelingen a
-- LEFT JOIN medewerkers m ON a.hoofd = m.mnr;
...
-- -- WHERE i.cursus = 'S02' AND i.begindatum = TO_DATE('2019-04-12', 'YYYY-MM-DD');
