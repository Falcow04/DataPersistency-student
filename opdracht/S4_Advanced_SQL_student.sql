...
-- SELECT (MAX(EXTRACT(YEAR FROM CURRENT_DATE) - EXTRACT(YEAR FROM gbdatum)) - 
--         MIN(EXTRACT(YEAR FROM CURRENT_DATE) - EXTRACT(YEAR FROM gbdatum))) AS verschil,
